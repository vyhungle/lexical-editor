 ...
 *
 */
import { DOMConversionMap, DOMConversionOutput, DOMExportOutput, EditorConfig, ElementNode, LexicalNode, SerializedElementNode, Spread } from 'lexical';
declare type SerializedCollapsibleContentNode = Spread<{
